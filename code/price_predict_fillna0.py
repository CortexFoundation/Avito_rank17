...
check_point = ModelCheckpoint('price_model_fill0.hdf5', monitor = "val_loss", mode = "min", save_best_only = True, verbose = 1)
...
import pickle
with open('price_embedding_dict.p','wb') as f:
    pickle.dump(embedding_dict,f)
"""
model.load_weights('price_model_fill0.hdf5')
preds = model.predict(X_nan,verbose=1)

test_id["price_pred"]=preds.reshape(-1)
test_id.to_csv('../input/label_price_features_fill0.csv',index=None)
