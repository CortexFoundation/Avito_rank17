...
from keras.layers import Concatenate, Flatten, Bidirectional,Dropout
...
test_id["price_pred_v5"]=preds.reshape(-1)
test_id.to_csv('../input/label_price_features_v5.csv',index=None)
