...
check_point = ModelCheckpoint('price_model.hdf5', monitor = "val_loss", mode = "min", save_best_only = True, verbose = 1)
...
"""
model.load_weights('price_model.hdf5')
preds = model.predict(X_nan,verbose=1)

test_id["price_pred"]=preds.reshape(-1)
test_id.to_csv('../input/label_price_features.csv',index=None)
