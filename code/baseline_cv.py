...
shift_fe=[]
shift=data_small.copy()
"""
shift["activation_dayofyear"]=shift["activation_dayofyear"]-1
for i in ["user_id","parent_category_name","category_name","image_top_1"]:
    data_small,fe=get_type_feature_all(data_small,shift,[i,"activation_dayofyear"],"deal_probability","mean","shift-1")
    shift_fe.append(fe)
"""
shift["activation_dayofyear"]=shift["activation_dayofyear"]+1
for i in ["user_id","parent_category_name","category_name","image_top_1"]:
    data_small,fe=get_type_feature_all(data_small,shift,[i,"activation_dayofyear"],"deal_probability","mean","shift1")
    shift_fe.append(fe)
"""
shift["activation_dayofyear"]=shift["activation_dayofyear"]+1
for i in ["user_id","parent_category_name","category_name","image_top_1"]:
    data_small,fe=get_type_feature_all(data_small,shift,[i,"activation_dayofyear"],"deal_probability","mean","shift2")
    shift_fe.append(fe)

shift["activation_dayofyear"]=shift["activation_dayofyear"]+1
for i in ["user_id","parent_category_name","category_name","image_top_1"]:
    data_small,fe=get_type_feature_all(data_small,shift,[i,"activation_dayofyear"],"deal_probability","mean","shift3")
    shift_fe.append(fe)
"""
...
item_features["image"]=item_features["FileName"]
del item_features["FileName"]
...
for col in ["param_1"]:
    data_small,fe = get_type_feature_all(data_small, data_small, [col], "deal_probability", "nunique","label_nunique")
    count_features.append(fe)
